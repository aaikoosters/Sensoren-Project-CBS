...
 		double deg2rad(double degrees)
		...
		void searchHeading() 		{ 			// start the compass sensor 			CrossDeviceMotion.Current.Start(MotionSensorType.Compass, MotionSensorDelay.Default); 			CrossDeviceMotion.Current.SensorValueChanged += (s, a) => 			{ 				switch (a.SensorType) 				{ 					//  					case MotionSensorType.Compass: 						var _cmd = new CompasMotionDetect(lblHeading, a); 						break; 				} 			}; 		} 	} }  